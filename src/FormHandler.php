...
class FormHandler
{
	...
	public function __construct()
	{
		...
		$this->mailer->Subject = "Mensaje de un cliente";

		$host = isset($_SERVER['SERVER_NAME'])?$_SERVER['SERVER_NAME']:'localhost';
        $from_email ='forms@'.$host;
   		$this->mailer->setFrom($from_email,'Mi pagina web ',false);  
	...
	/**
	 * sendEmailTo: agregar una dirección de correo electrónico del destinatario
	...
	public function process($post_data)
	{
		...
		return json_encode(['result'=>'Enviado']);
	}
	...
	{
		$content = "El siguiente cliente se ha puesto en contacto con vosotros";
